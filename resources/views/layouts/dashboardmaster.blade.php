...
<head>
  ...
  <link href="{{ asset('dashboard_assets') }}/../../css2?family=Roboto:wght@300;400;500;700;900&display=swap" rel="stylesheet">
  <!-- End fonts -->
  ...
  <!-- Layout styles -->
	<link rel="stylesheet" href="{{ asset('dashboard_assets') }}/css/demo1/style.min.css">
  <!-- End layout styles -->
	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#catagory" role="button" aria-expanded="false" aria-controls="catagory">
            ...
            <div class="collapse" id="catagory">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('catagory.create') }}" class="nav-link">Add Catagory</a>
                </li>
                <li class="nav-item">
                  <a href="pages/email/read.html" class="nav-link">View Catagory</a>
                </li>
              ...
              <div class="input-group-text">
                ...
                <div class="p-1">
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                      <img class="wd-30 ht-30 rounded-circle" src="{{ asset('dashboard_assets') }}/images/faces/face2.jpg" alt="userr">
                    </div>
                  ...
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                      <img class="wd-30 ht-30 rounded-circle" src="{{ asset('dashboard_assets') }}/images/faces/face3.jpg" alt="userr">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-4">
                        <p>Carl Henson</p>
                  ...
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                      <img class="wd-30 ht-30 rounded-circle" src="{{ asset('dashboard_assets') }}/images/faces/face4.jpg" alt="userr">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-4">
                        <p>Jensen Combs</p>
                  ...
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                      <img class="wd-30 ht-30 rounded-circle" src="{{ asset('dashboard_assets') }}/images/faces/face5.jpg" alt="userr">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-4">
                        <p>Amiah Burton</p>
                  ...
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                      <img class="wd-30 ht-30 rounded-circle" src="{{ asset('dashboard_assets') }}/images/faces/face6.jpg" alt="userr">
                    </div>
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-4">
                        <p>Yaretzi Mayo</p>
                    ...
                    <div class="flex-grow-1 me-2">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<img class="wd-30 ht-30 rounded-circle" src="{{ asset('dashboard_assets') }}/images/faces/face1.jpg" alt="profile">
							</a>
							<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
								<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
									<div class="mb-3">
										<img class="wd-80 ht-80 rounded-circle" src="{{ asset('dashboard_assets') }}/images/faces/face1.jpg" alt="">
									</div>
...
@yield('content')
  ...
  <script src="{{ asset('dashboard_assets') }}/js/dashboard-light.js"></script>
